            ...
            {{duration:0.3,ease:easeing}}>
                ...
                <div className='Petd'>
                    ...
                    <div className='flex'>
                        <div className='divl'>
                                <ul>
                                <motion.li variants={fadeInUp}><span>Pet ID: </span><br />pname</motion.li>
                                <motion.li variants={fadeInUp}><span>Pet Name: </span><br />pname</motion.li>
                                <motion.li variants={fadeInUp}><span>Pet Category: </span><br />pname</motion.li>
                                <motion.li variants={fadeInUp}><span>Indentifications: </span><br />pname</motion.li>
                            ...
                            <div className='divR'>
                            <ul>
                                <motion.li variants={fadeInUp}><span>Pet Breed: </span><br />pname</motion.li>
                                <motion.li variants={fadeInUp}><span>Pet Colour: </span><br />pname</motion.li>
                                <motion.li variants={fadeInUp}><span>Pet Owner Name: </span><br />pname</motion.li>
                                </ul>
                                </div>
                    </div>
